...
>(({ className, children, ...props }, ref) => {
  ...
  const getDialogContentClasses = () => {
    if (isXpTheme) {
      return cn(
        "fixed left-[50%] top-[50%] z-[10000] grid w-full max-w-lg translate-x-[-50%] translate-y-[-50%] gap-4 p-0 shadow-lg duration-200 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 origin-center",
  ...
  return (
    <DialogPortal>
      <DialogPrimitive.Overlay className="fixed inset-0 z-[10000] bg-black/30 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0" />
